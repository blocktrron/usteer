...
static int
usteer_element_header_accessible(char *buf, unsigned int buf_len, char *tagged_element)
{
...
static int
usteer_element_accessible(char *buf, unsigned int buf_len, char *tagged_element)
{
	char *endptr = buf + buf_len;
...
static int
usteer_element_list_has_next(char *buf, unsigned int buf_len, char *current_element)
{
...
static char *
usteer_element_list_next(char *element)
{
	return ELEMENT_NEXT(element);
}

static int
usteer_element_list_empty(char *buf, unsigned int buf_len, char *p)
{
	char *endptr = buf + buf_len;
...
static char *
usteer_element_list_find_element(char *buf, unsigned int buf_len, char element)
{
	char *p = buf;
...
static int
usteer_element_list_remove_element(char *buf, unsigned int buf_len, char elem)
{
	char *p = usteer_element_list_find_element(buf, buf_len, elem);
	...
	memset(p + buf_len - element_len_total, 0, element_len_total);
